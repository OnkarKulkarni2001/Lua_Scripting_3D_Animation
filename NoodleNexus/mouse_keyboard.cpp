...
//        }
 ...
 //   if (mods == GLFW_KEY_LEFT_CONTROL)
    ...
    if (areAllModifiersUp(window))
    {
        ...
        {
            //std::ifstream luaCommandFile("lua_commands-Copy.txt");
        ...
        if (key == GLFW_KEY_F8 && action == GLFW_PRESS)
        {
            ...
            ::g_pMyLuaMasterBrain->RunScriptImmediately(
                "AddSerialCommand('MOVE_TO', 'New_Viper_Player', 180.0, 0.0, 0.0, 5)");

            //::g_pMyLuaMasterBrain->RunScriptImmediately(
            //    "AddSerialCommand('FOLLOW_CURVE', 'New_Viper_Player', 0.0, 0.0, 0.0, 250.0, 250.0, 0.0, 500.0, -250.0, 0.0, 750.0, 0.0, 0.0, 15)");

            /*::g_pMyLuaMasterBrain->RunScriptImmediately(
                "AddParallelCommand('FOLLOW_OBJECT', 'New_Viper_Player_1', 'New_Viper_Player', 0.0, 5.0, 0.0, 15.0)");*/
            
            //::g_pMyLuaMasterBrain->RunScriptImmediately(
            //    "AddSerialCommand('MOVE_TO', 'New_Viper_Player', 10.0, 0.0, 0.0, 10)");
